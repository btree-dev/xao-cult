---
name: supabase-docs
description: Use before working on a Supabase feature in this repo — explains how to search and read the Supabase docs mirrored at /supabase/docs via `ssh supabase.sh`.
---

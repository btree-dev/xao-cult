                  ...
                  <div className={styles.ticketColumn}>
                    ...
                    <div className={styles.contractInput}>
                            ...
                            <Image
                                ...
                                onClick={() =>
                                setActiveDropdown(
                                    activeDropdown === `securityDollarAmount-${index}` ? null : `securityDollarAmount-${index}`
                                )
                                }
                            />
                            {activeDropdown === `securityDollarAmount-${index}` && (
                                <div className={styles.dropdownMenu}>
                                {dropdownOptions.map(option => (
                                    <div
                                    key={option}
                                    className={styles.dropdownOption}
                                    onClick={() => {
                                        updateSecurityDepositRow(index, "dollarAmount", option);
                                        setActiveDropdown(null);
                                    }}
                                    >
                                    {option}

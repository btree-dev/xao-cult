...
import { useUserContractsWithSummaries, CONTRACT_STATUS_LABELS, formatContractDate, getStatusColor } from '../hooks/useGetContracts';
  ...
  return (
    <Layout>
      ...
      />
              ...
              >
                <div className={styles.feedHeader}>
                  <div className={styles.feedAuthor}>
                    ...
                    <div className={styles.headerTag} style={{
        ...
        {/* Empty state for contracts when connected but no contracts */}
        {isConnected && (!contracts || contracts.length === 0) && !contractsLoading && (
          <div className={styles.feedContainer} style={{ marginBottom: '20px' }}>
            <div style={{
